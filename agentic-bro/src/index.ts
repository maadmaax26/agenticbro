...
import slaRoutes from '../routes/brand-guard/sla';
import urlScanRoutes from '../routes/url-scan';
import websiteScanRoutes from '../routes/website-scan';
app.use('/api/v1/scan', scanRoutes);
app.use('/api/v1/scan', urlScanRoutes);
app.use('/v1/website', websiteScanRoutes);
