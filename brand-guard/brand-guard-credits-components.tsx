...
const SUBSCRIPTION_PLANS = [
  {
    ...
    features: ['50 scans/month', '3 brands', 'Weekly monitoring', 'Email alerts', 'Takedown templates'],
    highlight: false,
  },
  {
    id: 'sentinel',
    ...
    features: ['200 scans/month', '10 brands', 'Daily monitoring', 'Priority alerts', 'Auto takedown filing', 'Domain monitoring'],
    highlight: true,
  },
  {
    id: 'fortress',
    ...
    features: ['Unlimited scans', 'Unlimited brands', 'Real-time monitoring', 'Dedicated support', 'Auto takedown + follow-up', 'Full threat correlation', 'API access'],
    highlight: false,
  },
];
