          ...
          <div className="bg-gradient-to-br from-purple-950/40 to-gray-900/60 border border-purple-500/20 rounded-3xl p-10">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <ul className="space-y-3">
                  {['Identify signal channels by actual win/loss record, not hype', 'Detect early whale accumulation before price moves', 'Spot bot activity and coordinated pump-and-dump setups', 'Get risk-adjusted trade recommendations based on real data', 'Holder Tier: 100 ALL scans/month (Profile, Phone, Token, Channel)', 'Whale Tier: Unlimited scans'].map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-gray-300">
        ...
        <section className="text-center">
          <div className="bg-gradient-to-br from-purple-900/30 to-gray-900/60 border border-purple-500/20 rounded-3xl p-12">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-8">
              Every scan you skip is a risk you could have avoided. Agentic Bro gives you your first 5 scans free --
