...
# X/Twitter Profile Scam Scanner - Chrome CDP Fixed Version
# Replaces scan-x.sh to use authenticated browser automation

PROFILE_URL="https://x.com/${1#@}"
SCAN_TIMESTAMP=$(date '+%Y-%m-%d %H:%M:%S %Z')
OUTPUT_FILE="/Users/efinney/.openclaw/workspace/output/x-profile-reports/scan-x-cdp_fixed_${SCAN_TIMESTAMP}.md"
